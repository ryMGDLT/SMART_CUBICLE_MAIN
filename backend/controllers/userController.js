...
const loginUser = async (req, res) => {
  try {
    ...
    if (user.status === "Pending") {
      ...
      return res
        .status(403)
        .send("Pending approval. Please contact your employer to approve your signup request.");
    }
    ...
    if (user.status === "Declined") {
      ...
      return res
        .status(403)
        .send("Your account has been declined. Please contact support for further assistance.");
    }
