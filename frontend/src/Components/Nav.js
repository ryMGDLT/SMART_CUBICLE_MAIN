...
import { BellIcon, LogoutIcon, ChevronLeftIcon, ChevronRightIcon, MenuIcon, XIcon } from "@heroicons/react/solid";
  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      <div 
        ...
        style={{ marginLeft: isSidebarVisible && window.innerWidth >= 768 ? (collapsed ? "5rem" : "16rem") : "0" }}
      >
        {/* Navbar */}
